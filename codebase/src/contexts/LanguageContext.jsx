...
const translations = {
  vi: {
    ...
    dayBadgeLabel: "BÀI",
    lessonPrefix: "Bài",
    slideCountReal: (n) => `${n} trang slide bài giảng`,
    slideCountFallback: "Slide bài giảng",
    aiAnalysisNote: "AI tự phân tích sơ đồ Mindmap & RAG",
  ...
  en: {
    ...
    dayBadgeLabel: "DAY",
    lessonPrefix: "Lesson",
    slideCountReal: (n) => `${n} lecture slides`,
    slideCountFallback: "Lecture slides",
    aiAnalysisNote: "AI auto-generates the Mindmap & RAG analysis",
